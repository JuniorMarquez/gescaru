(function () {
    ...
    function CreditoController(logger,
        ...
        vm.operaciones = {};
        var randomnumber=Math.floor((Math.random() * 9999) + 99999);
        vm.credito.numero = randomnumber*parseInt(vm.credito.id_socio);
...
vm.aperturar3 =function() { 
            MyService.data.extra2 = vm.credito.id;
            MyService.data.extra = vm.credito.id_socio;
            MyService.data.x = "nop";
            MyService.data.dato= vm.credito.monto;
            MyService.data.val= vm.credito.numeroMeses;
        };
vm.aperturar4 =function() { 
            MyService.data.extra2 = vm.credito.id;
            MyService.data.extra = vm.credito.id_socio;
            MyService.data.x = "nos";
            MyService.data.dato= vm.credito.monto;
